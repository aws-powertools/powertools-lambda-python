...
if scenario == "static":
    ...
    from aws_lambda_powertools.utilities.auth.jwt.exceptions import InvalidSignatureError
    ...
    jwt_auth = importlib.import_module("aws_lambda_powertools.utilities.auth.jwt")
