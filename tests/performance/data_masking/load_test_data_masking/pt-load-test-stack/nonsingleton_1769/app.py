...
from aws_lambda_powertools.utilities.data_masking.providers.aws_encryption_sdk import AwsEncryptionSdkProviderWithoutSingleton
...
@app.get("/nonsingleton1769")
@tracer.capture_method
def nonsingleton1769():
    logger.info("Hello world non singleton1769 - HTTP 200")
    data_masker = DataMasking(provider=AwsEncryptionSdkProviderWithoutSingleton(keys=[KMS_KEY_ARN]))
    ...
    return {"Decrypted_json_blob_non_singleton_1769": decrypted}
