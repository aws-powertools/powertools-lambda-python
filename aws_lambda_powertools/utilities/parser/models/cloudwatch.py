...
class CloudWatchLogsLogEvent(BaseModel):
    ...
    timestamp: datetime = Field(
        description="The time when the event occurred, expressed as the number of milliseconds since Jan 1, 1970 00:00:00 UTC.",
