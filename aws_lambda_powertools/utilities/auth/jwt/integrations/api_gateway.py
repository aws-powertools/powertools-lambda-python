...
from aws_lambda_powertools.utilities.auth.jwt._internal.authorization import (
    ForbiddenError,
    bearer_token,
    enforce_scopes,
    header_token,
...
from aws_lambda_powertools.utilities.auth.jwt.exceptions import AuthError, InvalidClaimsError, InvalidTokenError
