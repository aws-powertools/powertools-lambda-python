...
if TYPE_CHECKING:
    ...
    from aws_lambda_powertools.utilities.auth.jwt.integrations.event_handler import AuthErrorContext, AuthMiddleware
...
class Verifier(ABC):
    ...
    def require(
        ...
        *,
        ...
        ```
        """
        from aws_lambda_powertools.utilities.auth.jwt.integrations.event_handler import AuthMiddleware
    ...
    def authorize(
        ...
        *,
        ...
        ```
        """
        from aws_lambda_powertools.utilities.auth.jwt.integrations.api_gateway import authorize_event
