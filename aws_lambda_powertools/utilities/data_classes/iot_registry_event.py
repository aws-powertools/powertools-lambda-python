...
# TODO convert these to event source models and inherit from DictWrapper
...
class IoTCoreThingEvent(DictWrapper):
    """
...
class IoTCoreThingTypeEvent(DictWrapper):
    """
...
class IoTCoreThingTypeAssociationEvent(DictWrapper):
    """
...
class IoTCoreThingGroupEvent(DictWrapper):
    """
...
class IoTCoreAddOrRemoveFromThingGroupEvent(DictWrapper):
    """
...
class IoTCoreAddOrDeleteFromThingGroupEvent(DictWrapper):
    """
