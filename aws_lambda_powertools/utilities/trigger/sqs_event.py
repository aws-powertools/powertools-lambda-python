...
class SQSRecordAttributes:
    def __init__(self, record_attributes: dict):
        self._val = record_attributes

    @property
    def aws_trace_header(self) -> Optional[str]:
        """Returns the AWS X-Ray trace header string."""
        return self._val.get("AWSTraceHeader")
    ...
    def approximate_first_receive_timestamp(self) -> str:
        ...
        return self._val["ApproximateFirstReceiveTimestamp"]
    ...
    def message_group_id(self) -> Optional[str]:
        ...
        return self._val.get("MessageGroupId")
    ...
    def message_deduplication_id(self) -> Optional[str]:
        ...
        return self._val.get("MessageDeduplicationId")


class SQSMessageAttribute:
    """The user-specified message attribute value."""

    def __init__(self, message_attribute: dict):
        self._val = message_attribute

    @property
    def string_value(self) -> Optional[str]:
        """Strings are Unicode with UTF-8 binary encoding."""
        return self._val["stringValue"]
