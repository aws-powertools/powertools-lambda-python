...
* **Invoke locally**: `sam local invoke HelloWorldFunction --event events/event.json`
...
```bash
example$ sam build --use-container
```
...
Tests are defined in the `tests` folder in this project. Use PIP to install the deps and run unit tests.
