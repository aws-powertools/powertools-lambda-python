...
* **deps-dev:** bump the boto-typing group with 2 updates ([#5152](https://github.com/aws-powertools/powertools-lambda-python/issues/5152))
* **deps-dev:** bump aws-cdk from 2.156.0 to 2.157.0 ([#5151](https://github.com/aws-powertools/powertools-lambda-python/issues/5151))
...
* **deps-dev:** bump aws-cdk-lib from 2.156.0 to 2.157.0 ([#5154](https://github.com/aws-powertools/powertools-lambda-python/issues/5154))
* **deps-dev:** bump pytest from 8.3.2 to 8.3.3 ([#5153](https://github.com/aws-powertools/powertools-lambda-python/issues/5153))
