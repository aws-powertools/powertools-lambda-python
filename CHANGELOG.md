...
* **governance:** add Powertools for AWS Lambda (.NET) in issue templates ([#2196](https://github.com/aws-powertools/powertools-lambda-python/issues/2196))
...
* **homepage:** emphasize additional Powertools for AWS Lambda languages ([#1292](https://github.com/aws-powertools/powertools-lambda-python/issues/1292))
...
* **logger:** clone Powertools for AWS Lambda (Python) logger config to any Python logger ([#927](https://github.com/aws-powertools/powertools-lambda-python/issues/927))
...
* expose jmespath Powertools for AWS Lambda (Python) functions ([#736](https://github.com/aws-powertools/powertools-lambda-python/issues/736))
