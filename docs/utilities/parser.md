...
| **S3EventNotificationEventBridgeDetailModel** | Lambda Event Source payload for Amazon S3 Notification to EventBridge. <br /> To be used with `envelopes.EventBridgeEnvelope`. |
