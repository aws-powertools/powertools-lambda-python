...
| **S3EventNotificationEventBridgeModel** | Lambda Event Source payload for Amazon S3 Event Notification to EventBridge. <br /> To be used with `envelopes.EventBridgeEnvelope`. |
