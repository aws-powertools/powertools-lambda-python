...
|---------------------|---------------------------------|---------------------------------|
| SSM Parameter Store | `get_parameter`                 | `ssm:GetParameter`              |
| SSM Parameter Store | `get_parameters`                | `ssm:GetParametersByPath`       |
| SSM Parameter Store | `SSMProvider.get`               | `ssm:GetParameter`              |
| SSM Parameter Store | `SSMProvider.get_multiple`      | `ssm:GetParametersByPath`       |
| Secrets Manager     | `get_secret`                    | `secretsmanager:GetSecretValue` |
