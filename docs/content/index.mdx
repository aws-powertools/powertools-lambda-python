...
POWERTOOLS_TRACE_DISABLED | Disables tracing | "false" | [Tracing](./core/tracer)
POWERTOOLS_TRACE_MIDDLEWARES | Creates sub-segment for each middleware created by lambda_handler_decorator | "false" | [middleware_factory](./utilities/middleware_factory)
POWERTOOLS_LOGGER_LOG_EVENT | Logs incoming event | "false" | [Logging](./core/logger)
POWERTOOLS_LOGGER_SAMPLE_RATE | Debug log sampling  | 0 | [Logging](./core/logger)
POWERTOOLS_METRICS_NAMESPACE | Metrics namespace  | None | [Metrics](./core/metrics)
LOG_LEVEL | Sets logging level | "INFO" | [Logging](./core/logger)
