...
=== "SAM"
    ...
    MyLambdaFunction:
        ...
        Properties:
            Layers:
                - !Sub arn:aws:lambda:${AWS::Region}:017000801446:layer:AWSLambdaPowertoolsPython:18
    ```
...
=== "Terraform"
    ...
    resource "aws_lambda_function" "test_lambda" {
      ...
      handler       = "index.test"
      runtime 		= "python3.9"
      layers 		= ["arn:aws:lambda:{region}:017000801446:layer:AWSLambdaPowertoolsPython:18"]
