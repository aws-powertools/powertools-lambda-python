...
??? note "Note: Click to expand and copy any regional Lambda Layer ARN"
    ...
    === "arm64"
        ...
        | Region           | Layer ARN                                                                                                        |
        | ---------------- | ---------------------------------------------------------------------------------------------------------------- |
        | `af-south-1`     | [arn:aws:lambda:af-south-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:     |
        | `ap-east-1`      | [arn:aws:lambda:ap-east-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:      |
        | `ap-northeast-1` | [arn:aws:lambda:ap-northeast-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard: |
        | `ap-northeast-2` | [arn:aws:lambda:ap-northeast-2:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard: |
        | `ap-northeast-3` | [arn:aws:lambda:ap-northeast-3:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard: |
        | `ap-south-1`     | [arn:aws:lambda:ap-south-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:     |
        | `ap-south-2`     | [arn:aws:lambda:ap-south-2:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:54](#){: .copyMe}:clipboard:     |
        | `ap-southeast-1` | [arn:aws:lambda:ap-southeast-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard: |
        | `ap-southeast-2` | [arn:aws:lambda:ap-southeast-2:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard: |
        | `ap-southeast-3` | [arn:aws:lambda:ap-southeast-3:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard: |
        | `ca-central-1`   | [arn:aws:lambda:ca-central-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:   |
        | `eu-central-1`   | [arn:aws:lambda:eu-central-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:   |
        | `eu-central-2`   | [arn:aws:lambda:eu-central-2:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:54](#){: .copyMe}:clipboard:   |
        | `eu-north-1`     | [arn:aws:lambda:eu-north-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:     |
        | `eu-south-1`     | [arn:aws:lambda:eu-south-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:     |
        | `eu-south-2`     | [arn:aws:lambda:eu-south-2:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:54](#){: .copyMe}:clipboard:     |
        | `eu-west-1`      | [arn:aws:lambda:eu-west-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:      |
        | `eu-west-2`      | [arn:aws:lambda:eu-west-2:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:      |
        | `eu-west-3`      | [arn:aws:lambda:eu-west-3:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:      |
        | `il-central-1`   | [arn:aws:lambda:il-central-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:54](#){: .copyMe}:clipboard:   |
        | `me-central-1`   | [arn:aws:lambda:me-central-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:54](#){: .copyMe}:clipboard:   |
        | `me-south-1`     | [arn:aws:lambda:me-south-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:     |
        | `sa-east-1`      | [arn:aws:lambda:sa-east-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:      |
        | `us-east-1`      | [arn:aws:lambda:us-east-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:      |
        | `us-east-2`      | [arn:aws:lambda:us-east-2:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:      |
        | `us-west-1`      | [arn:aws:lambda:us-west-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:      |
        | `us-west-2`      | [arn:aws:lambda:us-west-2:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53](#){: .copyMe}:clipboard:      |
    ...
    === "arm64"
        ...
        === "SAM"
            ...
            MyLambdaFunction:
                ...
                Properties:
                    Architectures: [arm64]
                    Layers:
                        - !Sub arn:aws:lambda:${AWS::Region}:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53
            ```
        ...
        === "Serverless framework"
        	...
        	functions:
        		hello:
                    ...
                    architecture: arm64
        		    layers:
        		  	- arn:aws:lambda:${aws:region}:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53
            ```
            ...
            class SampleApp(core.Construct):
                ...
                def __init__(self, scope: core.Construct, id_: str, env: core.Environment) -> None:
                    ...
                    powertools_layer = aws_lambda.LayerVersion.from_layer_version_arn(
                        self,
                        id="lambda-powertools",
                        layer_version_arn=f"arn:aws:lambda:{env.region}:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53"
                    )
                    aws_lambda.Function(self,
                        'sample-app-lambda',
                        runtime=aws_lambda.Runtime.PYTHON_3_9,
        ...
        === "Terraform"
            ...
            resource "aws_lambda_function" "test_lambda" {
              ...
              handler       = "index.test"
              runtime 		= "python3.9"
              layers 		= ["arn:aws:lambda:{region}:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53"]
              architectures = ["arm64"]
        ...
        === "Amplify"
            ...
            ...
            ? Do you want to enable Lambda layers for this function? Yes
            ? Enter up to 5 existing Lambda layer ARNs (comma-separated): arn:aws:lambda:eu-central-1:017000801446:layer:AWSLambdaPowertoolsPythonV2-Arm64:53
            ❯ amplify push -y
